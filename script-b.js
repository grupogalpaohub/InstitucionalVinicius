...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const animatedElements = document.querySelectorAll('.area-card, .produto-card, .conteudo-card, .bullet-item, .timeline-item');
...
document.addEventListener('DOMContentLoaded', function() {
    const cards = document.querySelectorAll('.area-card, .produto-card, .conteudo-card');
...
function agendarConsulta() {
    ...
    modal.innerHTML = `
        ...
        ">
            ...
            <p style="margin-bottom: 2rem;">Redirecionando para o sistema de agendamento...</p>
...
document.addEventListener('DOMContentLoaded', function() {
    const icons = document.querySelectorAll('.card-icon, .produto-icon, .conteudo-icon');
...
document.addEventListener('DOMContentLoaded', function() {
    const sections = document.querySelectorAll('.sobre, .areas, .produtos, .conteudos');
